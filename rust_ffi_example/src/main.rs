extern "C" {
    ...
    fn minus_in_static1(a: i32, b: i32) -> i32;
}
...
fn minus_in_static1_wrap(a: i32, b: i32) -> i32 {
    unsafe { minus_in_static1(a, b) }
}
...
fn main() {
    ...
    println!("minus_in_static1_wrap: {}", minus_in_static1_wrap(1, 2));
}
